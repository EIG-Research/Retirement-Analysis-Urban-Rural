...
avg_ret # SIPP reports nearly $10,000 more retirment savings on average than SCF, not counting the inflation from SIPP's 2021 dollars to SCF's 2022 dollars
...
# the p-value is close to 0 and the 95% CI is [-5.23,-3.21], hence SIPP has larger mean account size than SCF
```
